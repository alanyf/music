...
envConfigList.forEach(config => {
    const envName = config.name;
    const baseUrl = config.baseUrl;
    config.branchList.forEach(branch => {
        ...
        webpackConfig.plugins.push(new HtmlWebpackPlugin(configObj));// 需要生成几个html文件，就配置几个HtmlWebpackPlugin对象
    });
});
