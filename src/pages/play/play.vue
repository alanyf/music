...
@click="back"><van-icon name="arrow-left"/></div>
			...
			<div class="share" >
				<van-icon
name="./static/images/icon/icon_upload.svg"
@click="share"/>
			</div>
		</header>
		<section
...
class="word-content">
					<div
v-for="(row, i) in wordArr"
:key="row.startTime"
:class="i===wordFocusIndex?'focus':''">
						{{ row.text }}
					</div>
				</div>
			</div>
...
class="head-img">
		...
		<section class="operation">
			<div class="collection"><van-icon
name="like-o"
@click="collection"/></div>
			<div class="download"><van-icon
name="diamond-o"
@click="download"/></div>
			<div class="show-word"><van-icon
name="comment-o"
@click="showWord"/></div>
			<div class="comment">
...
@change="processChange"/>
		...
		<section class="control">
			<div class="play-model">
				<van-icon
v-if="changeMusicModel==='order'"
name="descending"
@click="changePlayModel"/>
				<van-icon
v-if="changeMusicModel==='random'"
name="exchange"
@click="changePlayModel"/>
				<van-icon
v-if="changeMusicModel==='loop'"
name="replay"
@click="changePlayModel"/>
			</div>
			<div class="previou-music"><van-icon
name="arrow-left"
@click="previous"/></div>
...
@click="start"/>
			...
			<div class="next-music"><van-icon
name="arrow"
@click="next"/></div>
			<div
class="recent-music-menu"
@click="$store.commit('changeIsShowBottomSidebar', true);"><van-icon name="bars"/></div>
		</section>
	</div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            secondToMinute(second) {
                ...
                let secondBite = addZero(_minute); let minuteBite = addZero(_second);
