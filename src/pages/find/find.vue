        ...
        <section class="recommend-list">
            <div class="list-hearder">
                ...
                <div class="hearder-button">
                    <router-link to="/music/playListSquare"> <van-tag
                        round
                        plain
                        color="#333">歌单广场</van-tag></router-link>
                </div>
            </div>
            <div class="list-content">
                <div
                    v-for="_arr in playListForm.slice(0, 2)"
                    :key="_arr[0].id"
                    class="list-row">
                    <div
                        v-for="item in _arr"
            ...
            <div class="list-hearder">
                ...
                <div class="hearder-button">
                    <router-link to="/music/playListSquare"> <van-tag
                        round
                        plain
                        color="#333">更多新碟</van-tag></router-link>
                </div>
            </div>
            <div class="list-content">
