<template>
    <div class="my-container">
            ...
            <div
                ...
                <div
                    ...
                    <div class="list-name">
                        ...
                        <van-icon
                            v-if="listInListening===item.title"
                            name="volume"
                            class="isListening"/>
                    </div>
                </div>
        ...
        <secxtion class="music-list">
            <div
                v-for="(musicListItem, i) in musicList"
                :key="musicListItem.title"
                class="list-item">
                <div
                    class="header-bar"
                    @click="triggerMusicList(i)">
                    <div class="door-icon">
                        <van-icon
                            :class="`${isShowMusicList[i]?'':'rotate'}`"
                            name="arrow-down" />
                    </div>
                    <div class="title" >{{ musicListItem.title }}<div class="item-num">({{ musicListItem.list.length }})</div></div>
                    <div
                        class="add-icon"
                        @click.stop><van-icon name="plus"/></div>
                    <div
                        class="more-icon"
                        @click.stop><van-icon
                            name="ellipsis"
