    ...
    <div class="comment-container">
        ...
        <div class="main-content">
            ...
            <div class="conmment-content">
                <div
                    v-for="(comment, i) in hotComments"
                    :key="comment.id"
                    class="comment-item">
                    <div class="list-row">
                    ...
                    <div class="comment-text">
                        {{ comment.content }}
                        <div
                            v-for="reply in isShowAllReply[i]?comment.reply:comment.reply.slice(0,2)"
                            :key="reply.id"
                            class="reply-item">
            ...
            this.$ajax.get('/music/comment/music?id=' + this.musicId).then((res) => {
                ...
                that.comments = res.comments.map(e => {
                    return {
                        ...
                        reply: e.beReplied.map(o => {
                            return {id: o.id, content: o.content, user: {id: o.userId, nickname: o.user.nickname, picUrl: o.user.avatarUrl}};
                        }),
